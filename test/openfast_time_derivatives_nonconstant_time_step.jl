...
# err ≈ dt^p = (T/N)^p
# err2/err1 ≈ ((T/N2)^p)/((T/N1)^p) = ((T/N2)/(T/N1))^p = (N1/N2)^p
# log(err2/err1) ≈ log((N1/N2)^p) = p*log(N1/N2)
# p ≈ log(err2/err1)/log(N1/N2) ≈ (log(err2) - log(err1))/(log(N1) - log(N2)) = -(log(err2) - log(err1))/(log(N2) - log(N1))
